...
jQuery(document).ready(function($) {
	if (metadata && metadata.pageType === "main_index") {
		...
		// Remove title attributes from the index's links to buttons.
		// When JavaScript is enabled, the title attribute "break" the Bootstrap tooltips/popovers. ¬¬
		// When JavaScript is disabled, the title attribute stays and is used as tooltip.
		$(".btn-index-name-link").removeAttr("title");
	}
